          ...
          <Card id="contribute" className="relative overflow-hidden group scroll-mt-35">
            ...
            <div className="relative z-10 p-8 sm:p-12 text-center space-y-6">
              ...
              <p className="text-base sm:text-lg text-muted-foreground leading-relaxed max-w-3xl mx-auto">
                We're not hiring at the moment, but feel free to register your profile in our database and we will review it <span className="whitespace-nowrap">(technical or non-technical)</span>, whether you share our vision and want to contribute right away, or if you'd like us to consider your profile once recruitment opens.
              </p>
